...
/** @brief "TBL2" - BL2 manifest */
#define MANIFEST_ID_MIS (0x324c4254U)

/** @brief "" - FW_BUNDLE_TOC_ID*/
#define FW_BUNDLE_TOC_ID (0x434f5450U)

/** @brief AES-128-CBC */
#define FW_BUNDLE_ENCYRYPTION_TYPE_AES (0x01)
...
struct fw_bundle_manifest {
	 ...
	 * Allowed values:
	 *	@ref FW_BUNDLE_ENCYRYPTION_TYPE_AES
	 ...
	 * The type of signature contained in this field is indicated by the @rerf signature_type
